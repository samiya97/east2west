                                    ...
                                    <form enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="form-group  right-icon">
                                                 <span><i class="fa fa-flag"></i></span>
                                                    <select name="country" onChange="showPost(this.value)" class="select custom-form form-control">
                                        ...
                                        <div class="form-group"  id="ShowPost" > 
                                        ...
                                        <div class="form-group" id="Show"> 
                                         ...
                                         <div class="form-group">
                                             <input type="text" class="form-control" name="stars"  placeholder="Stars"  required/>
...
{
include("connection.php");
$ab = "INSERT INTO tbl_hotel(name, Description, location,country,state,city, stars, email , Password , Status)
VALUES ('".$_POST['name']."', '".$_POST['Description']."', '".$_POST['location']."', '".$_POST['country']."', '".$_POST['state']."', '".$_POST['city']."', '".$_POST['stars']."','".$_POST['email']."','".$_POST['Password']."', 'Pending')";
