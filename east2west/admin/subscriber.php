...
<html lang="en">
    <head>
        ...
        <title>EAST2WEST | Subscriber Email</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Subscriber</h2>
                                    <div>
                                        <ul class="breadcrumb">
                      ...
                      <div class="widget has-shadow">
                                ...
                                include("connection.php");
                                  $p = mysqli_query($var,"SELECT * FROM tbl_newsletter");
                                  ...
                                  ?>
                                               ...
                                               <tr role="row" class="even">
                                                        ...
                                                        <td class="td-actions">
                                                            ...
                                                            <a href='<?php echo "email-delete.php?action=delete&id=$idd";?>' onclick="return confirm('Are you sure you want to delete this?');"><i class="la la-close delete"></i></a>
                                                        </td>
                                                    </tr>
